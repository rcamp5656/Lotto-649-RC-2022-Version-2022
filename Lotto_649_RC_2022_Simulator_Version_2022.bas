Rem *** Lotto 649 Simulator Version 2022 RC22 Working Version With Automatic Draw Date Update
...
Locate 6, 9
Print " Lotto 649 2022 RC2022 Version Lotto 649 Simulator Final Vers"
Locate 7, 9
...
Locate 11, 14
Print "Release Date  : Jan 7  -  12:01 AM                 "
Locate 12, 14
Print "Registered To :                                    "
Locate 12, 30
Print reg$
...
Cls
Print
Print "Welcome to the Lotto 649 2022 Simulator. This program"
...
Input "[At $4.00 per set of numbers  ]  : ", sets
If sets = 0 Then GoTo main
If (sets * 4) > previousbalance Then
    Print
...
For l = 1 To total
    ...
    Do Until today$ = "Wednesday" Or today$ = "Saturday"
...
Print "You have bought "; sets; "sets of 6 numbers from 1 to 49"
Print
...
If crs$ = "Y" Then Color 10, 5
Locate 5, 8
Print "        Lotto 649 Simulator RC 2022 Version 2022  Main Menu       "
...
Open "Lotto649.dat" For Input As #1
checkforwinners:
...
Do Until EOF(1)
    ...
    If match > 2 Then
        ...
        Print Using "## ## ## ## ## ## ##"; entry(1); entry(2); entry(3); entry(4); entry(5); entry(6); entry(7)
        Print "  > "; match; " Correct."
        If hardcopy$ = "Y" Then
            LPrint "Match for : ";
...
Input "How many Numbers [Maximum 6]: ", numbrs
...
For i = 1 To linecounter
    ...
    For j = 4 To 10
        If za = chart(i, j) Or zb = chart(i, j) Or zc = chart(i, j) Or zd = chart(i, j) Or ze = chart(i, j) Or jf = chart(i, j) Or zg = chart(i, j) Then
            match = match + 1
        End If
        If zh = chart(i, j) And match = 6 Then
            match = match + 1
        End If
    Next j
Next i
...
Do Until EOF(2)
    ...
    tickets = tickets + 1
    Input #2, ac, bc, cc, dc, ec, fc
    If wa = ac Or wa = bc Or wa = cc Or wa = dc Or wa = ec Or wa = fc Then
        winnings = winnings + 1
    End If
    If wb = ac Or wb = bc Or wb = cc Or wb = dc Or wb = ec Or wb = fc Then
        winnings = winnings + 1
    End If
    If wc = ac Or wc = bc Or wc = cc Or wc = dc Or wc = ec Or wc = fc Then
        winnings = winnings + 1
    End If
    ...
    If wg = ac Or wg = bc Or wg = cc Or wg = dc Or wg = ec Or wg = fc Then
        winnings = winnings + 1
    End If
    If wh = ac Or wh = bc Or wh = cc Or wh = dc Or wh = ec Or wh = fc Then
        bonus = bonus + 1
    End If
    ...
    If winnings = 6 Then
        ...
        Print Using "## ## ## ## ## ##    Bonus : ##"; wa; wb; wc; wd; we; wf; wg;
...
Cls
Print
Print "Total of 3/6       Payouts of free tickets            ==> "; payout3
Print "Total of 4/6       Payouts of $20.00 Cash is            $ "; payout4
Print "Total of 5/6       Payouts of $96.50 Cash is            $ "; payout5
Print "Total of 5/6 +     Bonus Payouts of $197,679.00 Cash is $ "; payout5b
Print "Total of 6/6       Payouts of $1,000,000 Cash        is $ "; payout6
Print
Print "Press any key to continue..."
Do While InKey$ = ""
Loop
correctnum = payout3 + payout4 + payout4 + payout5 + payout5b + payout6
grandtotalcash = cash3total + cash4total + cash5total + cash5btotal + cash6btotal
Cls
Print
...
Print
Print "The winning numbers were : "; wa; wb; wc; wd; we; wf; " Bonus # "; wg
Print
Print "Press any key to continue ....."
Print
Do While InKey$ = ""
...
Open "lotto649.dat" For Append As #1
GoSub getdate
beginning:
Cls
Print
Print "Lotto 649 Package Version 2022 RC 2022 Winning Numbers Entry"
Print "------------------------------------------------------------"
Print
...
If entryg < 1 Or entryg > 49 Then Print "Number Out of Range !": GoTo sixth
If entryg = entryf Or entryg = entrye Or entryh = entryd Or entryg = entryc Or entryg = entryb Or entryg = entrya Then Print "Number already picked !": GoTo sixth
Print
Print "You Have Entered for the draw of : "; d5$; " "; month$(month12); " "; day12; year12
Print entrya; " "; entryb; " "; entryc; " "; entryd; " "; entrye; " "; entryf; " "; " Bonus  :"; entryg
Print
verify:
...
For i = 1 To linecounter
    ...
    bonus(chart(i, 10)) = numb(chart(i, 10)) + 1
...
Print #1, Using "## ## ####  ## ## ## ## ## ## ## ##"; month12; day12; year12; entrya; entryb; entryc; entryd; entrye; entryf; entryg
Return
...
Cls
Print
Print "Lotto 649 2022 RC 2022 Simulation Program With Real Time Game Play Rules."
Print "---------------------------------------------------------------------"
Print
...
Cls
Print
Print "Basic Rules and object of this Lotto 649 2022 RC 2022 Lottery Simulator"
Print "-------------------------------------------------------------------"
Print
Print "You start out with a variable amount, and the object"
Print "of the game is to win $1 Million dollars by matching"
Print "all 6 numbers from 1 to 49. "
Print
Print "Prize Payout (Not in real dollars but funny money)."
Print "---------------------------------------------------"
Print
Print "Cash for 3/6  Numbers Matched                   = Free Ticket"
Print "Cash for 4/6  Numbers Matched                   = $20.00"
Print "Cash for 5/6  Numbers Matched                   = $96.50"
Print "Cash for 5/6  Numbers Matched and Bonus matched = $791.50"
Print "Cash for 6/6  Numbers Matched                   = $3,822.00"
Print
...
Print
Print
Print "About This Lotto 649 RC 2022 Simulator and all of the other"
Print "information that you need to play for fun or real time."
Print
Print "(1) Lotto 649 Simulator Intoduction."
Print "(2) Is it worth playing the lotteries in the long run?"
Print "(3) Lotto 649 Payouts (not real money) for this simulator."
Print "(4) Basic Rules for this Lotto 649 Simulator."
Print "(5) Lotto 649 Simulator Explaination."
Print "(6) Welcome to the Lotto 649 2022 RC 2022 Simulator'"
Print "(7) Lotto 649 Simulator plays in real time or fun mode."
Print "(8) Lotto 649 Simulator Program Information"
